...
%>
<a style="float:left">You have yet to add a Payment Method.</a><br>
</br><a style="float:left">Please provide your Payment details through the link below.</a><br>
...
<a style="float:left" href="updatePaymentMethod.jsp">Change payment method.</a><br>
<%
      }
    } else {
